...
#pragma warning restore CS0219 // La variable 'auxI' está asignada pero su valor nunca se usa
        ...
        {
            String[] tablas = { "TBL_Proceso","TBL_Operacion","TBL_Insercion_empleado_proceso","TBL_Receta,tbl_empleados","TBL_Estado_proceso","TBL_Estado_empleado" };
